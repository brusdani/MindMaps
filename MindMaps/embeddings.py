...
# Example usage:
input_folder = 'evaluation/assignment/strings/prompts'  # Folder containing the text files
output_file = 'evaluation/assignment/embeddings/prompts/prompts.json'  # File to store the embeddings
