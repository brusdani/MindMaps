...
input_folder_eiffel = 'evaluation/maps/rag_london'  # Folder containing Churchill JSON files
output_folder = 'evaluation/Strings/rag_london'  # Folder to store the generated text files
